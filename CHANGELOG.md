...
- **NOT yet live-verified** — needs a GM client and a player client with an owned PC. Holding for confirmation before commit, per project working method.
...
- **NOT yet live-verified against a real campaign character sheet** — this touches every attack path. Holding for confirmation before commit, per project working method.
...
- **NOT yet live-verified against a real campaign character sheet** — this touches every attack path (Full Auto, Burst, semi-auto, and indirectly the module-facing `armourBonusHooks` regression guard for Destined Inherent/Power Armour). Holding for confirmation before commit, per project working method.
