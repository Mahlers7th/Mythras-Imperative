...
- **Called from**: `CombatEngine._afterDefenceResolved` (`~L949`), Step 8, only when `ctx.defenceType` is `'evade'` or `'acrobatics'` — not consulted for Parry, Don't Defend, or a surprised defender.
